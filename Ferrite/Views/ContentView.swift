            ...
            .overlay {
                    ...
                    !isEditingSearch
                {
                    EmptyInstructionView(
                        ...
                        message: pluginManager.filteredInstalledSources.isEmpty ? "" : "Check your source filter and redo your search.",
                        systemName: pluginManager.filteredInstalledSources.isEmpty ? "exclamationmark.triangle" : "magnifyingglass"
                    )
                }
            }
            .expandedSearchable(
